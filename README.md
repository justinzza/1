...
- 收录美国 Amazon.com、加拿大 Amazon.ca、墨西哥 Amazon.com.mx；美国站优先。新增站点独立核验与建立基线，不把范围配置当作已完成新闻采集。支持站点及五类事件筛选、稳定事件锚点、本机行动清单保存。按用户要求，网站不再展示 DAILY BRIEFING / 分类摘要板块；保留重点变化、覆盖说明、事件档案与行动清单。
